...
<body style="overflow-x: hidden;">
	...
	<div class="page-wrapper">
		...
		<!-- Map Column -->
		<div class="p-3" >
			<div class="p-3" style="border-radius: 10px; background-color: #19AC5C#FA4318; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
				<br>
				<br>

				<div class="sec-title alternate centered ">
					<h4 class="title " style="color: #024285;">Get In Touch</h4>
				</div>
										...
										<div class="contact-form">
											<form method="post" action="https://html.themexriver.com/industo/sendemail.php" id="contact-form">
												<div class="row clearfix">
													...
													<div class="col-lg-12 col-md-12 col-sm-12 form-group">
														<button class="theme-btn btn-style-eight clearfix animated hover-scale" id="contact_btn" style="background-color: #024285; color: white;">
															<span class="btn-wrap">
