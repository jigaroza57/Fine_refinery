                ...
                <div class="col-md-3">
                    <div class="footer-widget newsletter-widget">
                        ...
                        <a href="https://maps.app.goo.gl/g1YYeFhAzaoKYYPF7" target="_blank" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-location-dot" style="font-size: 25px; colo"></i>
                        ...
                        <a class="mt-2" href="tel: +91 9825209230" style="display: flex; gap: 20px; colo">
                        ...
                        <a class="mt-2" href="mailto: info@finerefiners.com" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-envelope" style="font-size: 25px; colo"></i>
