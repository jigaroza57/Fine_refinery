						...
						<div class="inner-column">
							...
							<div class="row clearfix">
								<div class="col-lg-6 col-md-6 col-sm-12">
									<ul class="list">
										<li>We follow ASTM/BIS standards for testing recycled base oil and fuel oil.</li>
										<li>Our tests confirm that materials meet Schedule 5 or 6 requirements before processing.</li>
									</ul>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12">
									<ul class="list">
										<li>While we conduct rigorous testing, the ultimate responsibility lies with the material owners.</li>
										<li>Our state-of-the-art laboratory facilities ensure that all products are thoroughly tested for top-notch quality before market release.</li>
									</ul>
								</div>
							</div>
							<!-- Quality Box -->
