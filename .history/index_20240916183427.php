...
<body>
    ...
    <div class="page-wrapper">
                        ...
                        <div class="inner-box">
                            <div class="image">
                                ...
                                <div class="overlay-box">
                                    <span class="icon flaticon-factory" style="background: #024285;"></span>
                                    <div class="content">
                                ...
                                <div class="overlay-box-two">
                                    ...
                                    <div class="overlay-inner">
                                        <div class="overlay-content">
                                            ...
                                            <a href="service.php" class="read-more" style="background: #024285;">Read more <span class="flaticon-next-3"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="service-block-two style-two">
                        <div class="inner-box">
                            <div class="image">
                                ...
                                <div class="overlay-box-two">
                                    <span class="icon-two flaticon-home"></span>
                                    <div class="overlay-inner">
                                        <div class="overlay-content">
        ...
        <section class="news-section">
            ...
            <div
                class="pattern-layer-two"
                style="background-image: url(img/FRPL-2.png)"></div>
            <div
                class="pattern-layer-three"
                style="background-image: url(img/e3_blue.png)"></div>
            <div class="auto-container">
                <div class="sec-title">
