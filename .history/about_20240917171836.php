						...
						<div class="inner-column mt-4">
							...
							<div class="quality-box">
								<div class="quality-inner" style="display: flex; align-items: flex-start;">
									<div class="icon-container" style="margin-right: 15px;">
										<span class="icon flaticon-trophy-2" style="font-size: 24px;"></span>
									</div>
									<div class="content-container" style="flex: 1;">
										<h4 style="margin: 0;">Best Quality</h4>
										<div class="text" style="margin: 10px 0 0;">
