				...
				<div class="row clearfix">
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="inner-column mt-4">
							...
							<!-- Quality Box -->
							<div class="quality-box" style=" display: flex;  align-items: flex-start;">
								<div class="content" style=" display: flex;  align-items: flex-start;">
									<span class="icon flaticon-trophy-2" style="margin-right: 15px;   flex-shrink: 0;"></span>
									<div class="text-container" style="max-width: calc(100% - 40px);">
										<h4>Best Quality</h4>
