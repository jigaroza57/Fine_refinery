...
<body>
    <footer
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="footer-widget logo-widget">
                        <div class="logo">
                            <!-- <center> -->
                            <a href="index.php">
                                <img src="new_img/new_logo.png" style="height: 17vh;" alt="" title="">
                            </a>
                            <!-- </center> -->
                        </div>
                        <div class="text ">
                ...
                <div class="col-md-2">
                    <div class="footer-widget newsletter-widget">
                        ...
                        <div class="text">
                            ...
                            <a href="">
                                <p style="color: white;">Fraud Alert
                                </p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="footer-widget newsletter-widget">
                        ...
                        <a href="https://maps.app.goo.gl/g1YYeFhAzaoKYYPF7" target="_blank" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-location-dot" style="font-size: 25px; color: #FA4318;"></i>
                        ...
                        <a class="mt-2" href="tel: +91 9825209230" style="display: flex; gap: 20px; color: #FA4318;">
                        ...
                        <a class="mt-2" href="mailto: info@finerefiners.com" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-envelope" style="font-size: 25px; color: #FA4318;"></i>

                            <p style="color: white;">info@finerefiners.com</p>
        ...
        <div style="position: fixed; bottom: 22px; right: 18px; ">
            <a href="tel:+91-9825209314" style="text-decoration: none;">
                <div style="width: 40px; height: 40px; background-color: #FA4318; border-radius: 50%; display: flex; justify-content: center; align-items: center; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
                    <svg width="25" height="25" viewBox="0 0 29 26" xmlns="http://www.w3.org/2000/svg">
