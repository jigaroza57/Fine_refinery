...
<head>
	...
	<style>
		...
		.quality-box .quality-inner .icon-container {
			text-align: center;
			/* Center the content horizontally */
		}

		.quality-box .quality-inner .icon-container .icon {
			display: block;
			/* Ensure the icon takes its own line */
			margin: 0 auto;
			/* Center the icon horizontally */
		}

		.quality-box .quality-inner .icon-container h4 {
			margin-top: 10px;
			/* Space between the icon and the heading */
		}

		.quality-box .quality-inner .icon-container .text {
			margin-top: 5px;
