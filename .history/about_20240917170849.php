	...
	<div class="page-wrapper">
		...
		<center>
			<div class="container mob_only_welcome">
				...
				<h1 class="" style="font-size: 25px;  font-family: 'Playfair Display', serif; font-style: italic; color: #FA4318;">Fine Refiners PVT. LTD.</h1>
			</div>
		</center>
		<br>
		<br>
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="inner-column mt-4">
							...
							<div class="sec-title-three">
								...
								<h3>28+ Years of Experience in Oil Refinery</h3>
