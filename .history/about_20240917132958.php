	...
	<div class="page-wrapper">
		...
		<center>
			<div class="container mob_only_welcome">
				...
				<h1 style="font-size: 25px;  font-family: 'Playfair Display', serif; font-style: italic;">Fine Refiners PVT. LTD.</h1>
			</div>
		</center>
		<br>
		<br>
				...
				<div class="row clearfix">
					...
					<div class="image-column col-lg-5 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class=" wow " data-wow-delay="0ms" data-wow-duration="1500ms">
								<img src="img/ne1.jpg" class="mob_refinery" alt="" style=" width: 570px; height: 570px; " />
							</div>
						...
						<div class="inner-column">
							...
							<div class="quality-box">
								<div class="quality-inner">
									...
									<h4>Best Quality</h4>
									<div class="text">We adhere strictly to ASTM/BIS standards for testing recycled base oil and fuel oil. Our tests ensure that the material conforms to Schedule 5 or 6 before processing, even though the responsibility lies with the owners. Our excellent laboratory facilities guarantee thorough testing of our products, ensuring top-notch quality before they reach the market.</div>
								</div>
							</div>
