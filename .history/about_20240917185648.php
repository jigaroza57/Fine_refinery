...
<head>
	...
	<style>
		...
		@media (max-width: 768px) {
			...
			.mob_vision {
				position: relative;
				border: 3px solid #F23C1C !important;
				border-radius: 12px;
				padding: 20px;
				background: #ffffff;
		...
		@keyframes backgroundColorAnimation {
			...
			50% {
				background-color: rgb(239 87 52 / 58%);
			}
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="inner-column mt-4">
							...
							<div class="quality-box mob_only_welcome">
								<div class="icon-container">
									<img src="img/trophy.png" alt="Best Quality Trophy" class="icon-image">
