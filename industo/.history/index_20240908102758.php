...
/* Column Styling with Unique Designs */
.notice-col {
    ...
    position: relative;
    overflow: hidden;
    animation: noticeAnimation 1s forwards ease;
}
...
.investor-docs-col {
    ...
    position: relative;
    overflow: hidden;
    animation: investorAnimation 1.2s forwards ease;
}
...
.stock-col {
    ...
    position: relative;
    overflow: hidden;
    animation: stockAnimation 1.4s forwards ease;
}
