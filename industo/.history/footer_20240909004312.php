...
<body>
    <footer
                ...
                <div class="col-md-3">
                    <div class="footer-widget newsletter-widget">
                        ...
                        <a href="" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-location-dot" style="font-size: 25px; color: #0F79A9;"></i>
                        ...
                        <a class="mt-2" href="+91 +91 9825209230" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-phone" style="font-size: 25px; color: #0F79A9;"></i>
                        ...
                        <a class="mt-2" href="+91 +91 9825209230" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-envelope" style="font-size: 25px; color: #0F79A9;"></i>
        ...
        <div>
        <svg width="29" height="26" viewBox="0 0 29 26" style="color: #13562B;" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="29" height="25" fill="white" transform="translate(0 0.5)"/>
        ...
        <img src="img/speech-icon.svg" style="height: 4vh; position: fixed; bottom: 22px; right: 21px; color: white;" alt="">
