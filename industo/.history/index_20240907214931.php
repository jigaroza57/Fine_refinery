...
.shine-effect {
    position: absolute;
    bottom: 0; /* Position shine at the bottom */
    left: 0;
    width: 100%; /* Full width of the container */
    height: 20%; /* Adjust height to cover the bottom part of the image */
...
@keyframes shine {
    0% {
        transform: translateX(-100%); /* Move the shine effect from left to right */
    }
    50% {
        transform: translateX(100%); /* Move the shine effect to the right */
    }
    100% {
        transform: translateX(100%); /* End position of the shine effect */
    }
}
