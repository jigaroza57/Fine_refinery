...
<head>
    ...
    <style>
        ...
        .animated-image {
            ...
            margin: 0 auto;
            border-radius: 12px;
            box-shadow: 0 8px 0px rgba(15, 121, 169, 0.8);
    ...
    content: '';
    position: absolute;
    bottom: -50px; /* Adjust based on desired reflection position */
    left: 0;
    right: 0;
    height: 50px; /* Adjust based on desired reflection size */
    background: rgba(0, 0, 0, 0.2);
    transform: scaleY(-1);
    z-index: -1;
    box-shadow: none; /* Ensure shadow is not included in reflection */
    opacity: 0.5; /* Adjust for reflection visibility */
    filter: blur(5px); /* Optional: to blur the reflection */
}
        ...
        @keyframes glow {
            0% {
                box-shadow: 0 8px 10px rgba(15, 121, 169, 0.8), 0 0 0px rgba(255, 255, 255, 0);
            }

            50% {
                box-shadow: 0 8px 10px rgba(15, 121, 169, 0.8), 0 0 20px rgba(255, 255, 255, 0.8);
            }
        ...
        /* Shine effect adjusted to the bottom */
        .shine-effect {
            position: absolute;
            bottom: 0;
            /* Position shine at the bottom */
            left: 0;
            width: 100%;
            /* Full width of the container */
            height: 20%;
            /* Adjust height to cover the bottom part of the image */
        ...
        @keyframes shine {
            ...
            50% {
                transform: translateX(100%);
                /* Move the shine effect to the right */
            }

            100% {
                transform: translateX(100%);
                /* End position of the shine effect */
            }
        }
