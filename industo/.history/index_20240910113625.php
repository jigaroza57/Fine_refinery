...
<head>
    ...
    width: 100%;
    height: 100%;
    border-radius: 30px; /* Adjust this for rounded corners */
    box-shadow: inset 0 0 50px rgba(0, 0, 0, 0.8); /* Shadow only near the corners */
    z-index: 1;
    pointer-events: none; /* Make sure the overlay doesn't block content */
}
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="shine-container p-4" style="background: whitesmoke;">
            <br>
                ...
                <div class="prod-tabs tabs-box">
                    ...
                    <div class="tabs-content">
                        ...
                        <div class="tab" id="prod-construction">
                            <div class="image">
                                <img src="img/Low Aromatic.jpg" style="width: 1000px; height: 500px;" alt="" />
                                <div class="content">
                                    <div
                                        class="pattern-layer"
