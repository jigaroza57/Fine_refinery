...
.overlay {
    ...
    width: 100%;
    height: 100%;
    background: rgba(0, 0, 0, 0.3); /* Adjust overlay transparency */
    z-index: 1;
}
...
.content-column {
    position: relative;
    z-index: 2;
    color: #fff; /* Ensure text stands out on the video */
}
        ...
        <section class="main-slider">
            <div class="main-slider-video">
                ...
                <video autoplay loop muted playsinline class="video-bg">
                    <source src="videos/main-slider/video.mp4" type="video/mp4" />
