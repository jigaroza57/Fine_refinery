...
<body>
	...
	<div class="page-wrapper">
		...
		<!-- Approach Section -->
<section class="approach-section" style="background-image: url('img/vision-mission.webp'); background-repeat: no-repeat; background-size: cover; background-position: center;">
    <div class="auto-container">
        <!-- Sec Title Three -->
        <div class="sec-title alternate centered">
            <h2>Our Approach</h2>
            <div class="text">We Provide Innovative Solutions.</div>
        </div>

        <div class="row">
            <div class="col-md-6" style="position: relative; height: 100%;">
                <div style="position: absolute; top: 0; left: 0; width: 63%; height: 100%; background: #5e0b14; opacity: 0.8; clip-path: polygon(0 0, 72% 0, 100% 100%, 0 100%);">
                    <div style="padding: 20px; color: white;">
                        <h3>Our Vision</h3>
                        <hr style="border: 2px solid white; width: 100px;">
                        <p>We aspire to become the ultimate alliance that delivers unparalleled convenience to individuals of all environments, both present and future, thus earning their utmost respect and admiration.</p>

                        <h3>Our Mission</h3>
                        <hr style="border: 2px solid white; width: 100px;">
                        <p>Our unwavering commitment to surpass the expectations of our cherished customers through cutting-edge solutions and exceptional products and services is a legacy cherished for generations to come.</p>
                    </div>
                </div>
            </div>

            <div class="col-md-6" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;">
                <h3>Our Vision</h3>
                <hr style="border: 2px solid #5e0b14; width: 100px;">
                <p>We aspire to become the ultimate alliance that delivers unparalleled convenience to individuals of all environments, both present and future, thus earning their utmost respect and admiration.</p>
            </div>
        </div>
    </div>
