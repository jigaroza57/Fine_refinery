					...
					<div class="col-md-4" style=" display: flex;  flex-direction: column; align-items: center; justify-content: center; 
						...
						<div>
							...
							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<h5 class="mt-3" style="color: white;">Innovation and Technology Development </h5>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<h5 class="mt-3" style="color: white;">Sustainable Operations 	</h5>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<h5 class="mt-3" style="color: white;"> Community and Industry Engagement </h5>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<h5 class="mt-3" style="color: white;"> Economic Viability and Growth </h5>
							</div>
