...
.image img {
    width: 100%;
    display: block;
    border-radius: 10px; /* Image with rounded corners */
}
...
.circle-layer {
    ...
    opacity: 0.9; /* Semi-transparent for a glowing effect */
}
...
.gear-icon-two {
    position: absolute;
    font-size: 30px;
    color: #fff; /* White color for the gear icon */
                    ...
                    <div class="image-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="image-container">
                                <div class="image">
                                    <img src="images/resource/about.jpg" alt="About Image" />
