...
<body>
    <footer
        ...
        <div >
            <a href="tel: +91-9825209314" style="background-color: #ccc;">
                <svg width="29" height="26" viewBox="0 0 29 26" style="height: 4vh; position: fixed; bottom: 22px; right: 21px; color: #09ef5c;" xmlns="http://www.w3.org/2000/svg">
