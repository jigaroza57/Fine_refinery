...
<body>
    <footer
                ...
                <div class="col-md-3">
                    <div class="footer-widget newsletter-widget">
                        ...
                        <a class="mt-2" href="+91 +91 9825209230" style="display: flex; gap: 20px;">
                            <i class="fa-solid fa-phone" style="font-size: 25px; color: #FA4318;"></i>
        ...
        <div class="footer-bottom">
            <div class="copyright">
                &copy; 2024 Fine Refiners Private Limited - All rights reserved. &nbsp;&nbsp;&nbsp; All Rights Reserved By
                <a href="https://themeforest.net/user/themexriver">Apex Software House</a>
            </div>
        </div>
        </div>
    </footer>
