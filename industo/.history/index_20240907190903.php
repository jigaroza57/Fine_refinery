...
.animated-image:hover {
    ...
    /* Slight scaling and rotation on hover */
    box-shadow: 0 16px 32px rgba(15, 121, 169, 0.9), 0 20px 40px rgba(0, 128, 0, 0.6);
    /* Enhanced shadow */
    animation: boxShadowPulse 1.5s infinite; /* Add box-shadow animation */
}
...
@keyframes boxShadowPulse {
    ...
    50% {
        box-shadow: 0 20px 40px rgba(15, 121, 169, 1), 0 24px 48px rgba(0, 128, 0, 0.8);
    }
    100% {
        box-shadow: 0 16px 32px rgba(15, 121, 169, 0.9), 0 20px 40px rgba(0, 128, 0, 0.6);
    }
