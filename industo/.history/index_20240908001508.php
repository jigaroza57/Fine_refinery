                        ...
                        <div class="tab active-tab" id="prod-building">
                            <div class="image">
                                ...
                                <div class="content">
                                    <div
                                        class="pattern-layer"
                                        style="background-image: url(img/pr1.jpg); background-position: 10% 8% 20%;"></div>
                                    <h5>
                                        <a href="project-detail.html">Base Oil</a>
                                    </h5>
                                    <div class="category">
                                        <span>We are engaged in supplying Base Oil, which is light in color and have high viscosity & good solubility characteristics. </span>
                                    </div>
                                    <a
