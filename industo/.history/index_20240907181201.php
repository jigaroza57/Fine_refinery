...
<head>
    ...
    max-width: 100%;
    height: auto;
    border-radius: 10px; /* Add a border radius for a smooth look */
  ...
  /* Optional background styling for the logo area */
  .logo-container {
    text-align: center;
    background: linear-gradient(45deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.3)); /* Adds a gradient background */
    padding: 50px 0;
  }
    </style>
</head>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="logo-container">
            <img src="img/FRPL-0.1.png" class="custom-logo" alt="FRPL Logo">
        </div>
        <!-- Service Section -->
