...
.notice-col, .investor-docs-col, .stock-col {
    background: linear-gradient(135deg, #eafff5, #ccffeb);
    border-radius: 12px;
    padding: 20px;
...
.notice-item, .document-item {
    border-bottom: 1px solid #19AC5C;
    padding-bottom: 15px;
    margin-bottom: 15px;
}

.notice-item:hover, .document-item:hover {
...
.btn-theme:hover {
    background-color: #148d48;
}

.stock-info {
    background-color: white;
    border: 2px solid #19AC5C;
    border-radius: 12px;
    text-align: center;
    transition: background-color 0.3s ease;
}
            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 notice-col">
                        ...
                        <button class="btn btn-primary mt-4 notice-btn">Know More</button>
                    </div>
                    ...
                    <div class="col-md-4 investor-docs-col">
                        ...
                        <button class="btn btn-primary mt-4 document-btn">Know More</button>
                    </div>
                    ...
                    <div class="col-md-4 stock-col">
                        <div class="stock-info p-3">
                            ...
                            <p class="stock-price">₹2,929.65 <span>-56.30 (-1.89%)</span></p>
