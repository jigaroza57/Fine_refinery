...
<head>
    ...
    display: block;
    margin: 0 auto;
    width: 60%; /* Decreased width to make it more compact */
    border-radius: 12px;
    box-shadow: 0 8px 16px rgba(0, 128, 0, 0.6); /* Initial green shadow */
    transition: transform 0.5s ease-in-out, box-shadow 0.5s ease-in-out;
    animation: shadowPulse 2s infinite ease-in-out; /* Continuous shadow pulsing animation */
    max-width: 100%;
}
...
@keyframes shadowPulse {
    ...
    50% {
        box-shadow: 0 12px 24px rgba(0, 128, 0, 0.8);
    }
    100% {
        box-shadow: 0 4px 8px rgba(0, 128, 0, 0.2);
    }
...
.animated-shadow:hover {
    ...
    box-shadow: 0 16px 32px rgba(0, 128, 0, 0.9), 0 20px 40px rgba(15, 121, 169, 0.6); /* Enhanced shadow on hover */
}
