...
<head>
	...
	<style>
		...
		.content-column {
			padding: 30px;
			background: linear-gradient(135deg, #71ad74 0%, #519b68 100%);
			border-radius: 12px;
...
<section class="process-section">
    <div class="auto-container">
        <div class="row clearfix d-flex flex-wrap">
            ...
            <!-- Images Column -->
            <div class="images-column col-lg-6 col-md-12 col-sm-12 order-lg-1 order-2">
                <div class="inner-column">
            ...
            <!-- Content Column -->
            <div class="content-column col-lg-6 col-md-12 col-sm-12 order-lg-2 order-1">
                <div class="inner-column">
                    <!-- Sec Title -->
			...
			<div class="auto-container">
				...
				<div class="row">
					<div class="col-md-6">
						<h3>Our Vision</h3>
						<hr class="mt-4">
						<p style="font-size: 20px;">" To be the leading innovator in sustainable oil recycling, setting the global standard for environmental stewardship and resource efficiency while contributing to a circular economy. "</p>

						<br>
						<br>
						<h3>Our Mission</h3>
						<hr class="mt-4">
						<p style="font-size: 20px;">" Our mission is to advance the lifecycle of used oils through cutting-edge recycling technologies and refining processes. We are committed to reducing environmental impact by transforming waste into valuable resources, fostering sustainable practices, and delivering high-quality, eco-friendly products to our customers. "</p>
					</div>
