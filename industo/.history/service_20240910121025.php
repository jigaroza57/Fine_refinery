                    ...
                    <div class="video-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="video-box">
                                ...
                                <a href="img/walkthrough-video.mp4" class="lightbox-video overlay-box"><span class="flaticon-media-play-symbol transition-900ms"><i class="ripple"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="skill-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="sec-title-three light">
                                ...
                                <h4>Get a solution for all your Industries needs.</h4>
