			...
			<div class="auto-container">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<br>
						<p style="color:white;">" To be the leading innovator in sustainable oil recycling, setting the global
						...
						<hr class="mt-4" style="border: 1px solid white; width: 100px;">
						<br>
						<p style="color:white;">" Our mission is to advance the lifecycle of used oils through cutting-edge
					...
					<div class="col-md-4" style=" display: flex;  flex-direction: column; align-items: center; justify-content: center; 
						...
						<div>
							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font-size: 18px;">Environmental Impact Reduction</p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font-size: 18px;">Innovation and Technology Development </p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font-size: 18px;">Sustainable Operations 	</p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font-size: 18px;"> Community and Industry Engagement </p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font-size: 18px;"> Economic Viability and Growth </p>
							</div>
