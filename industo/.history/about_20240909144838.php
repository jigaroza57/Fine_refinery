					...
					<div class="col-md-5" style=" display: flex;  flex-direction: column; align-items: center; justify-content: center; 
						...
						<div >
							<div style="display: flex; gap: 20px;">
								...
								<h5 class="mt-3" style="color: white;">Environmental Impact Reduction</h5>
							</div>

							<div>
								<img src="img/trust.svg" style="height: 7vh;" alt="">
								<h5 class="mt-3" style="color: white;">Trust</h5>
							</div>

							<div>
								<img src="img/commitment.svg" style="height: 7vh;" alt="">
								<h5 class="mt-3" style="color: white;">Commitment</h5>
							</div>
							<div>
								<img src="img/integrity.svg" style="height: 7vh;" alt="">
								<h5 class="mt-3" style="color: white;">Innovation</h5>
							</div>
						</div>
