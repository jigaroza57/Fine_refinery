...
<head>
    ...
    <style>
        ...
        .animated-image::after {
            ...
            position: absolute;
            bottom: -50px;
            /* Adjust based on desired reflection position */
            left: 0;
            right: 0;
            height: 50px;
            /* Adjust based on desired reflection size */
            background: rgba(0, 0, 0, 0.2);
            transform: scaleY(-1);
            z-index: -1;
            box-shadow: none;
            /* Ensure shadow is not included in reflection */
            opacity: 0.5;
            /* Adjust for reflection visibility */
            filter: blur(5px);
            /* Optional: to blur the reflection */
        }
