...
<head>
    ...
    <style>
        ...
        .green-shadow {
            ...
            margin: 0 auto;
            /* Centering the image */
            box-shadow: 0 8px 16px rgba(15, 121, 169, 0.7), 0 12px 24px rgba(0, 128, 0, 0.4);
            /* Two-level shadow effect */
            border-radius: 12px;
            /* Rounded corners */
        ...
        .green-shadow:hover {
            ...
            box-shadow: 0 12px 24px rgba(15, 121, 169, 0.9), 0 16px 32px rgba(0, 128, 0, 0.6);
