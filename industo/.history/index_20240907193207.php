...
<head>
    ...
    <style>
        ...
        .animated-image {
            ...
            border-radius: 12px;
            /* Rounded corners */
            box-shadow: 0 8px 10px rgba(15, 121, 169, 0.8);
            /* Initial blue shadow */
            transition: transform 0.5s ease-in-out, box-shadow 0.5s ease-in-out;
            max-width: 80%;
            /* Decreased width */
            animation: float 3s ease-in-out infinite, glow 2s ease-in-out infinite;
            /* Continuous floating animation and white stroke glow animation */
        }
                        ...
                        <div class="inner-column">
                            ...
                            <div class="image">
                                ...
                                <div
                                    class="circle-layer"
                                    style="
    background-image: url('img/Fine Refiners.png');
    background-size: 50%; /* Adjust this percentage as needed */
