...
.sec-title-three h2 {
    font-size: 2.6em; /* Slightly smaller font size for better balance */
...
.location-block {
    ...
    box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1); /* Enhanced box shadow for depth */
    padding: 30px; /* Increased padding */
    margin-bottom: 30px; /* Adjusted bottom margin */
    transition: transform 0.3s ease-in-out, box-shadow 0.3s ease-in-out;
    border: 2px solid #007bff; /* Blue border */
    position: relative; /* Allows for additional styling elements */
}
...
.location-block p {
    font-size: 1.2em; /* Slightly larger font size for phone numbers */
    color: #495057;
}
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="location-block">
							<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
								<div class="content">
									<span class="icon flaticon-message" aria-hidden="true"></span>
