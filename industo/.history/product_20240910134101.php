            ...
            <div class="auto-container">
                <div class="clearfix">
                    <div class="pull-left logo-box">
                        <div class="logo">
                            <a href="index.php"><img src="img/green_logo.png" style="width: 120px;" alt="" title=""></a>
                        </div>
                    </div>
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="service.php"> Recycle Refiners</a></li>
                                            <li>
                                                <a href="service.php">Importer</a>
                                            </li>
            ...
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" title="">
                        <img src="img/green_logo.png" style="height: 8vh;" alt="" title="">
                    </a>
                </div>
                <!--Right Col-->
        ...
        <section id="section-home-project-casestudy" class="section section-home-project-casestudy theme-bg-section theme-padding">
            <div class="theme-bg-img img-position-top">
                <picture>
                    ...
                    <source media="(max-width:1000px)" srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/webp">
                    <source media="(max-width:1000px)" srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/jpeg">
                    <source media="(max-width:1350px)" srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/webp">
                    <source media="(max-width:1350px)" srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/jpeg">
                    <source srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/webp">
                    <source srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/jpg">
                    <img class="bg-img" src="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" width="1920" height="880" alt="Banner" />
                </picture>
            </div>
            <div class="theme-banner-text dark js-scroll fade-in-bottom scrolled">
                <div class="project-casestudy-logo">
                    <picture>
                        <source srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/webp">
                        <source srcset="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" type="image/png">
                        <img src="img/modern-factory-industrial-zone-blue-sky_181624-6369.jpg" width="200" height="200" alt="Paradigm Realty" />
                    </picture>
                </div>
                <div class="section-title">
