...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Service Section -->
        <section class="service-section" style="margin-top: 30%;">
    <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="service-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <div class="image-layer" style="background-image: url(images/resource/service.jpg); background-size: cover; background-position: center; filter: brightness(50%);"></div>
                        <div class="icon flaticon-factory"></div>
                        <h5>
                            <a href="oil-gas.html">Eco & Bio Power</a>
                        </h5>
                        <div class="text">
                            The manufacturing industry has become a key sector of production and labor in Europe and North America.
                        </div>
                ...
                <div class="service-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <h5>
                            <a href="oil-gas.html">Fuel & Gas Management</a>
                        </h5>
                        <div class="text">
                            The manufacturing industry has become a key sector of production and labor in Europe and North America.
                        </div>
                ...
                <div class="service-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <h5>
                            <a href="oil-gas.html">Chemical Research</a>
                        </h5>
                        <div class="text">
                            The manufacturing industry has become a key sector of production and labor in Europe and North America.
                        </div>
