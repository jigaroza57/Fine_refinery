...
<body>
	...
	<div class="page-wrapper">
		...
		<!-- Approach Section -->
		<section class="approach-section" style="background-image: url('img/vision-mission.webp'); background-repeat: no-repeat; ">
			<div class="auto-container">
				<!-- Sec Title Three -->
				<div class="sec-title alternate centered">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<hr class="mt-4" style="border: 2px solid white; width: 100px;">
						<br>
