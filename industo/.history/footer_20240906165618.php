                        ...
                        <div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
                                    <div class="logo">
                                        <a href="index.html">
                                            <img src="img/logo_bg.png" style="height: 17vh;" alt="" title="">
                                        </a>
                                    </div>
                                    <div class="text">
                                    The promoters of the company have more than a decade of experience in oil recycling business. The company is managed by Mr. Amin R.Vasaya(Director) who has vast experience in the field of recycling of used/waste oils.
                                    </div>
