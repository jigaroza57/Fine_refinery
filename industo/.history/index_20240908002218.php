                ...
                <div class="prod-tabs tabs-box">
                    ...
                    <div class="tabs-content">
                        ...
                        <div class="tab active-tab" id="prod-building">
                            <div class="image">
                                <img src="img/pr1.jpg" style="width: 1000px; height: 620px;" alt="" />
                                <div class="content">
                                    <div
                                        class="pattern-layer"
                                        style="background-image: url(img/pr1.jpg)"></div>
                                    <h5>
                                        <a href="project-detail.html">Base Oil</a>
                                    </h5>
                                    <div class="category">
                                        <span>We are engaged in supplying Base Oil, which is light in color and have high viscosity & good solubility characteristics. is used for making lubricants for transformers, hydraulics and other purposes. Our high quality range of Base oil is imported from other countries.</span>
                                    </div>
                                    <a
