...
/* Column Styling */
.notice-col, .investor-docs-col, .stock-col {
...
.notice-col:hover, .investor-docs-col:hover, .stock-col:hover {
    transform: translateY(-15px);
    box-shadow: 0 15px 30px rgba(0, 0, 0, 0.15);
}

.notice-col::before, .investor-docs-col::before, .stock-col::before {
    content: "";
    position: absolute;
    top: -50%;
    left: -50%;
    width: 200%;
    height: 200%;
    background-color: rgba(25, 172, 92, 0.15);
    border-radius: 50%;
    z-index: 0;
...
.notice-col:hover::before, .investor-docs-col:hover::before, .stock-col:hover::before {
    opacity: 1;
    transform: scale(0.8);
}

.notice-col h4, .investor-docs-col h4, .stock-info p {
    z-index: 1;
    position: relative;
}
...
.btn-theme {
    ...
    z-index: 1;
    position: relative;
    box-shadow: 0 5px 15px rgba(25, 172, 92, 0.3);
}
...
.stock-info {
    background: linear-gradient(145deg, #19AC5C, #148c46);
    border-radius: 15px;
    color: white;
    text-align: center;
    padding: 20px;
...
/* Image Styling */
.notice-item img, .document-item img {
    transition: transform 0.4s ease;
    z-index: 1;
}

.notice-item:hover img, .document-item:hover img {
        ...
        <section>
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-4 stock-col">
                        <div class="stock-info p-3">
