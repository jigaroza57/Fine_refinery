        ...
        <div class="auto-container">
            ...
            <div class="widgets-section">
                <div class="row clearfix">
                    <!-- Big Column -->
                    <div class="big-column col-lg-4 col-md-4 col-sm-4">
                        <div class="row clearfix">
                            <!-- Footer Column -->
                            ...
                            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget newsletter-widget">
                                    ...
                                    <div class="text">
                                        <a href="">
                                            <p style="color: #ccc;">Home</p>
                                        </a>
                                        <a href="">
                                            <p style="color: #ccc;">About Us</p>
                                        </a>
                                        <a href="">
                                            <p style="color: #ccc;">Services</p>
                                        </a>
                                        <a href="">
                                            <p style="color: #ccc;">Product</p>
                                        </a>
                                        <a href="">
                                            <p style="color: #ccc;">Contact us
                                            </p>
                                        </a>
                                    </div>
                                    <!-- <div class="text">
