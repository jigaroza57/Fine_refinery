...
.main-header .header-lower {
    background-color: transparent; /* Transparent header before sticky */
    box-shadow: none;
}

.main-header .sticky-header {
    background-color: rgba(0, 0, 0, 0.8); /* Darker background on sticky */
    transition: background-color 0.3s ease;
}

.main-header .navbar-collapse ul li a {
    color: white; /* Ensure visibility of navigation links */
}
...
.main-header .sticky-header .main-menu .navigation > li > a {
    padding: 23px 0;
    color: white;
    backdrop-filter: blur(5px); /* For a frosted glass effect */
    -webkit-backdrop-filter: blur(5px);
}

/* Dropdown Menu in Sticky Header */
.main-header .main-menu .navigation > li > ul {
    backdrop-filter: blur(5px); /* Adjust the blur effect as necessary */
    -webkit-backdrop-filter: blur(5px);
}
...
<body>
	...
	<div class="page-wrapper">
		...
		<!-- Page Title -->
		<!-- Page Title -->
		<section class="page-title" style="position: relative; background-image: url(images/background/9.jpg); background-size: cover; background-position: center; height: 55vh;">
			<!-- Overlay -->
			<div class="overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5);"></div>

			<div class="auto-container" style="position: relative; z-index: 1; text-align: center; color: white;">
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="sec-title-three">
								<div class="title"><span>Welcome to</span> Fine Refiners PVT. LTD.</div>
								<h4>28+ Years of experience in oil refinery.</h4>
								<div class="text">Fine Refiners Pvt. Ltd. is an ISO 9001 & 14001 certified company having license from CPCB & GPCB Authorization, established recently with most modern technology for recycling of used & waste oils as per the present day standards so that the environment is kept clean. The promoters of the company have more than a decade of experience in oil recycling business. The company is managed by Mr. Amin R.Vasaya(Director) who has vast experience in the field of recycling of used/waste oils.</div>
							</div>

							<!-- Quality Box -->
							<div class="quality-box">
								<div class="quality-inner">
									<!-- <span class="icon"><img src="img/astm.png" style="height:15%;width:15%"></span> -->
									<!-- #region -->
									<div class="text" style="display:flex;gap:20px">
										<i class="fa-solid fa-circle-check fa-2x " style="color:#024285"></i>
										<p>The company strictly follows the ASTM/BIS standards for testing of recycled base oil and recycled fuel oil. <br>
											Tests are also been conducted to decide that the material is used oil or waste oil as per Schedule 5 or 6 before lifting even though it is the responsibility of the owners.<br>
											It has an excellent laboratory facility for testing the products manufactured. <br>
											Thorough scrutiny is carried out for confirmation of the quality of the products before it is marketed.</p>
									</div>
								</div>
							</div>
