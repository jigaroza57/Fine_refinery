...
.sec-title-three .title {
    ...
    color: #ffffff;
    margin-bottom: 10px;
    text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); /* Adjusted shadow for better readability */
}
...
.quality-box::before {
    ...
    width: 100%;
    height: 5px;
    background-color: #4CAF50; /* Updated to match the new gradient */
...
.quality-box .quality-inner .icon {
    background-color: #2C6B40; /* Updated to match the new gradient */
    padding: 7px;
    border-radius: 50%;
