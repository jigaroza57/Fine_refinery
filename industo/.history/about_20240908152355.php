...
.sec-title-three .title .highlight {
    position: relative;
...
.sec-title-three .title .highlight::before {
    content: '';
    position: absolute;
    bottom: -5px;
    left: 0;
    width: 100%;
    height: 5px;
    background-color: #FFD700; /* Gold color for underline */
    opacity: 0.5;
    border-radius: 5px;
    transform: scaleX(0);
...
.sec-title-three .title .highlight:hover::before {
    transform: scaleX(1);
...
@keyframes highlightAnimation {
    ...
    100% {
		...
		.quality-box .quality-inner {
			...
			/* This makes the icon appear after the text */
		}
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="sec-title-three">
								<div class="title">
									<span>Welcome to</span> <span class="highlight">Fine Refiners PVT. LTD.</span>
								</div>
