                    ...
                    <div class="clearfix">
                        ...
                        <div class="top-right pull-right" style="display: flex; gap: 40px;">
                            ...
                            <div class="dropdown mt-3">
                                <label class="rogg" style="color: white; cursor: pointer;" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    eB2B <i class="fas fa-chevron-down"></i>
                                </label>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="z-index: 2;">
