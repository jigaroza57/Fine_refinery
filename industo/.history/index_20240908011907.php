                    ...
                    <div class="col-md-4">
                        ...
                        <div style="display: flex; gap: 20px;">
                            ...
                            <p style="font-size: 17px;">
                                ...
                                2023 - 2024 Financial Presentation - Q4 Results 22, April | 2024</p>
                        </div>

                        <br>
                        <br>

                        <button class="btn btn-primary mt-2">know more</button>


                    </div>
                    <div class="col-md-4">
                        <div class="p-3" style="border: 2px solid black;">
                            <p style="font-size: 24px; margin-bottom: -2px;">NSE (Reliance)</p>
                            <p>As on Sep 06, 2024 | 16:03</p>


                            <img src="img/arrow-down.png" alt="">

                            <p style="font-size: 17px; margin-bottom: -2px;">₹2,929.65 Arrow down-56.30 (-1.89%)</p>
