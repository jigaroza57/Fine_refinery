...
.welcome-text {
    color: #13562B; /* Dark green theme color */
}

.company-name {
    color: #19AC5C; /* Light green theme color */
}

.experience {
    font-size: 18px;
    color: #024285; /* Dark blue color for emphasis */
}
...
.quality-inner {
    display: flex;
    align-items: center;
    background-color: #eaf2e0; /* Light green background */
    padding: 15px;
    border-radius: 10px;
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
}
