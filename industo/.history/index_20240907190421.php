...
<head>
    ...
    box-shadow: 0 8px 16px rgba(0, 128, 0, 0.6); /* Green shadow */
...
.animated-image:hover {
    transform: scale(1.1) rotate(3deg); /* Slight scaling and rotation on hover */
    box-shadow: 0 16px 32px rgba(15, 121, 169, 0.9), 0 20px 40px rgba(0, 128, 0, 0.6); /* Enhanced shadow */
}
