                    ...
                    <div class="content-column col-lg-7 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="sec-title">
                                ...
                                <h3 style="line-height: 55px; letter-spacing: 1px;">Building a more competitive business sectors.</h3>
                                <div class="text">
                ...
                <div class="prod-tabs tabs-box">
                    ...
                    <div class="tabs-content">
                        ...
                        <div class="tab" id="prod-engineer">
                            <div class="image">
                                <img src="img/modern-factory-industrial-zone-blue-sky.jpg" alt="" />
                                <div class="content">
                                    <div
                                        class="pattern-layer"
