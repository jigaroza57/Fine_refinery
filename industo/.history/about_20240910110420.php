			...
			<div class="auto-container">
				...
				<div class="row">
					<div class="col-md-6">
						<h3>Our Vision</h3>
						<hr class="mt-4">
						<p style="font-size: ;">" To be the leading innovator in sustainable oil recycling, setting the global standard for environmental stewardship and resource efficiency while contributing to a circular economy. "</p>
						<h3>Our Mission</h3>
						<hr class="mt-4">
