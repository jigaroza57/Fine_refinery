					...
					<div class="col-md-4" style=" display: flex;  flex-direction: column; align-items: center; justify-content: center; 
						...
						<div>
							<div style="display: flex; gap: 20px;">
								...
								<p class="mt-3" style="color: white; font">Environmental Impact Reduction</p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font">Innovation and Technology Development </p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font">Sustainable Operations 	</p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font"> Community and Industry Engagement </p>
							</div>

							<div style="display: flex; gap: 20px;">
								<i class="fa-regular fa-circle-check fa-2x mt-3" style="color: white;"></i>
								<!-- <i class="fa-solid fa-check-double fa-2x" style="color: white;"></i> -->
								<p class="mt-3" style="color: white; font"> Economic Viability and Growth </p>
							</div>
