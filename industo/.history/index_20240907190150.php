...
<head>
    ...
    box-shadow: 0 8px 16px rgba(15, 121, 169, 0.7), 0 12px 24px rgba(0, 128, 0, 0.4); /* Two-level shadow effect */
...
.green-shadow:hover {
    ...
    box-shadow: 0 12px 24px rgba(15, 121, 169, 0.9), 0 16px 32px rgba(0, 128, 0, 0.6); /* Enhanced shadow on hover */
}
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <br>
        <br>
        <img src="img/FRPL-0.1.png" class="img-fluid p-4 green-shadow" alt="">
        <!-- Service Section -->
