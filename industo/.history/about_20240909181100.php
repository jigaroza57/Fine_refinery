			...
			<div class="auto-container">
				...
				<div class="row">
					<div class="col-md-6">
						<h3>Our Vision</h3>
						<hr class="mt-4">
						<p>" To be the leading innovator in sustainable oil recycling, setting the global standard for environmental stewardship and resource efficiency while contributing to a circular economy. "</p>
						<h3>Our Mission</h3>
						<hr class="mt-4">
						<p>" Our mission is to advance the lifecycle of used oils through cutting-edge recycling technologies and refining processes. We are committed to reducing environmental impact by transforming waste into valuable resources, fostering sustainable practices, and delivering high-quality, eco-friendly products to our customers. "</p>
					</div>
						...
						<div class="inner-box">
							<div class="author-box">
								<div class="author-inner">
									...
									<p style="color: white; font-size: 25px;">Apex Software House</p>
						...
						<div class="inner-box">
							<div class="author-box">
								<div class="author-inner">
									...
									<strong>Apex Software House</strong>
									<div class="designation">IT Company</div>
								</div>
							</div>
							<div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore Risus facilisis.</div>
