...
.notices, .investor-docs, .nse-data {
    padding: 30px;
...
.notices:hover, .investor-docs:hover, .nse-data:hover {
    transform: translateY(-10px);
    box-shadow: 0 12px 25px rgba(0, 0, 0, 0.2);
}

.notice-box, .doc-item, .stock-box {
    padding: 20px;
...
.notice-box::before, .doc-item::before, .stock-box::before {
    content: '';
    position: absolute;
    top: -100px;
    left: -100px;
...
.notice-box:hover, .doc-item:hover, .stock-box:hover {
    background-color: #fff;
    border-left-color: #13562B;
    box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);
}

.notice-box h5, .doc-item p, .stock-box p {
    color: #13562B;
    font-weight: bold;
}
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-4 nse-data">
                        <div class="stock-box">
                            ...
                            <img src="img/arrow-down.png" alt="Arrow Down" class="stock-arrow">
