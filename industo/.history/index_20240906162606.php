...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Industo Industry HTML-5 Template | Homepage 01</title>
    <!-- Stylesheets -->
  ...
  <body>
    ...
    <div class="page-wrapper">
        ...
        <div class="main-slider-carousel owl-theme owl-carousel">
          ...
          <div class="slide">
            ...
            <div
              ...
              style="background-image: url(images/main-slider/pattern-2.png)"
            ></div>
                ...
                <div class="inner-column">
                  ...
                  <div class="button-box">
                    <a class="btn-style-one theme-btn" href="services.html"
                      ><span class="txt"
                        >Our Services
                        <i class="arrow fa fa-angle-right"></i></span
                    ></a>
                  </div>
                </div>
              </div>
            ...
            <div class="row clearfix">
              ...
              <div class="service-block col-lg-4 col-md-6 col-sm-12">
                ...
                >
                  <div
                    class="shape-one"
                    style="background-image: url(images/icons/shape-1.png)"
                  ></div>
                  <div
                    class="shape-two"
                    style="background-image: url(images/icons/shape-2.png)"
                  ></div>
                  <div
                    class="image-layer"
                    style="background-image: url(images/resource/service.jpg)"
                  ></div>
                  <div class="icon flaticon-factory"></div>
                  <h5>
                    <a class="oil-gas.html" href="oil-gas.html"
                      >Eco & Bio Power</a
                    >
                  </h5>
                  <div class="text">
                  ...
                  <a class="read-more" href="oil-gas.html"
                    >Read More <span class="flaticon-right-arrow"></span
                  ></a>
                </div>
              </div>
              ...
              <div class="inner-column">
                ...
                <div class="lower-box clearfix">
                  <div class="button-box">
                    <a class="btn-style-one theme-btn" href="services.html"
                      ><span class="txt"
                        >About us <i class="arrow fa fa-angle-right"></i></span
                    ></a>
                  </div>
                  <div class="phone-box">
                    <div class="box-inner">
                  ...
                  <div class="overlay-box-two">
                    ...
                    <div class="overlay-inner">
                      <div class="overlay-content">
                        ...
                        <a href="oil-gas.html" class="read-more"
                          >Read more <span class="flaticon-next-3"></span
                        ></a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="content">
                    ...
                    <h5>
                      <a href="project-detail.html"
                        >City of Calgary LRT Station Refurbishments</a
                      >
                    </h5>
      ...
      <section class="products-section">
        ...
        <div
          class="pattern-layer-three"
          style="background-image: url(images/background/pattern-7.png)"
        ></div>
        <div
            ...
            <div class="product-block">
              <div class="inner-box">
                ...
                <div class="btn-box text-center">
                  <a class="read-more" href="oil-gas.html"
                    >Buy now <span class="flaticon-next-3"></span
                  ></a>
                </div>
              </div>
            </div>
            ...
            <div class="product-block">
              <div class="inner-box">
                ...
                <div class="image-box">
                  <div class="image">
                    <a href="oil-gas.html"
                      ><img src="images/resource/products/4.png" alt=""
                    /></a>
                  </div>
                </div>
                <h5>
      ...
      >
        ...
        <div
          class="pattern-layer-two"
          style="background-image: url(images/background/pattern-10.png)"
        ></div>
        <div class="auto-container">
          <div class="icon">
          ...
          <div class="button-box text-center">
            <a class="btn-style-one theme-btn" href="services.html"
              ><span class="txt"
                >Contact us <i class="arrow fa fa-angle-right"></i></span
            ></a>
          </div>
        </div>
      </section>
              ...
              <div class="inner-box">
                <div class="image">
                  ...
                  <div class="overlay-box-two">
                    <div
                      class="image-layer"
                      style="background-image: url(images/resource/news-4.jpg)"
                    ></div>
                      ...
                      <div class="overlay-content">
                        <h5>
                          <a href="blog-detail.html"
                            >The Chancellor has delivered his Budget ...</a
                          >
                        </h5>
                        <div class="text">
                          The Industrial Revolution, which took place from the
                  ...
                  <div class="overlay-box-two">
                    ...
                    <div class="overlay-inner">
                      <div class="overlay-content">
                        <h5>
                          <a href="blog-detail.html"
                            >Can You Sell A House Before the Probate?</a
                          >
                        </h5>
                        <div class="text">
                          The Industrial Revolution, which took place from the
      ...
      >
        <div class="auto-container">
                ...
                <div class="row clearfix">
                  ...
                  <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                    <div class="footer-widget logo-widget">
                      ...
                      <a href="about.html" class="theme-btn about-btn"
                        >About us</a
                      >
                    </div>
                  </div>
                  ...
                  <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                    <div class="footer-widget newsletter-widget">
                      ...
                      <div class="email-box">
                        <form
                          method="post"
                          action="https://html.themexriver.com/industo/contact.html"
                        >
                  ...
                  <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                    <div class="footer-widget contact-widget">
                      ...
                      <ul class="contact-list">
                        <li>
                          <span class="icon fa fa-phone"></span> 30 Commercial
                          Road <br />
                          Fratton, Australia
                        </li>
                        <li>
          ...
          <div class="footer-bottom">
            <div class="copyright">
              &copy; 2022 Industo - All rights reserved.
