...
<body style="overflow-x: hidden;">
	...
	<div class="page-wrapper">
		...
		<!-- Map Column -->
		<div class="p-3" >
			<div class="p-3" style="border-radius: 10px;  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); background-image: url('img/Untitled design (2).png');">
				<br>
				<br>

				<div class="sec-title alternate centered ">
					<h1 class="title " style="color: #ff3100;">Get In Touch</h1>
				</div>
